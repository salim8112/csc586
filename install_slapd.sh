...
echo -e "slapd slapd/root_password password Accsalim3012" |debconf-set-selections
echo -e "slapd slapd/password1 password Accsalim3012" |debconf-set-selections
echo -e "slapd slapd/internal/adminpw  password Accsalim3012" |debconf-set-selections

echo -e "slapd slapd/password2 password Accsalim3012" |debconf-set-selections
echo -e "slapd slapd/internal/generated_adminpw  password Accsalim3012" |debconf-set-selections  

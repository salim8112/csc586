...
echo -e "slapd slapd/password1 password" |debconf-set-selections
echo -e "slapd slapd/internal/adminpw  password" |debconf-set-selections

echo -e "slapd slapd/password2" |debconf-set-selections
echo -e "slapd slapd/internal/generated_adminpw  password" |debconf-set-selections  
